...
config.add('lclm_use_llm', bool, True, 'LCLM_USE_LLM', description='Whether LCLM should use LLM calls for planning/writing/formatting.')
...
config.add('lclm_enable_evidence', bool, True, 'LCLM_ENABLE_EVIDENCE', description='Whether LCLM evidence retrieval stage is enabled.')
config.add('lclm_enable_arxiv', bool, True, 'LCLM_ENABLE_ARXIV', description='Whether LCLM may call arXiv retrieval for evidence.')
config.add('lclm_enable_web', bool, True, 'LCLM_ENABLE_WEB', description='Whether LCLM may call web retrieval for evidence.')
